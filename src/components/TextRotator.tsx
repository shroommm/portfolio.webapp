...
function TextRotator() {
  ...
  >
    <div className="text-base sm:text-2xl font-medium [text-wrap:balance] text-gray-700">
    I am a Web Developer & a
      <span
      ...
      >
        ...
        >
          ...
          <li className="text-[#2f7df4]" aria-hidden="true">Student</li>
        </ul>
      </span>
    </div>
  </div>
